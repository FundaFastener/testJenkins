...
public class TjenTestContainer extends TestContainer {

    public TjenTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/tjen/app.properties",
    ...
    public static class Common extends TjenTestContainer {

        public static final TjenTestContainer.Common INSTANCE = new TjenTestContainer.Common();
